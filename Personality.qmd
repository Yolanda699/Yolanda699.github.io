...
[This page will present a box plot analysis examining the influence of scores obtained in five personality factors from the NEO-FFI-R questionnaire on patterns of drug consumption. The analyzed personality factors include **Agreeableness (A Score), Conscientiousness (C Score), Extraversion (E Score), Neuroticism (N Score), and Openness to Experience (O Score)**. A higher score indicates a greater likelihood of experiencing specific feelings within each respective category.]{style="font-size: 12pt; color: gray;"}
...
ggplot(drug_or, aes(x = factor(Alcohol), y = AScore)) +
  geom_boxplot() +
  labs(x = "Alcohol", y = "A Score") +
  ggtitle("Box Plot of A Score by Alcohol Consumption Level") +
...
ggplot(drug_or, aes(x = factor(Alcohol), y = Cscore)) +
  geom_boxplot() +
  labs(x = "Alcohol", y = "C Score") +
  ggtitle("Box Plot of C Score by Alcohol Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
...
ggplot(drug_or, aes(x = factor(Alcohol), y = Escore)) +
  geom_boxplot() +
  labs(x = "Alcohol", y = "E Score") +
  ggtitle("Box Plot of E Score by Alcohol Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
...
ggplot(drug_or, aes(x = factor(Alcohol), y = Nscore)) +
  geom_boxplot() +
  labs(x = "Alcohol", y = "N Score") +
  ggtitle("Box Plot of N Score by Alcohol Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
...
ggplot(drug_or, aes(x = factor(Alcohol), y = Oscore)) +
  geom_boxplot() +
  labs(x = "Alcohol", y = "O Score") +
  ggtitle("Box Plot of O Score by Alcohol Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
...
ggplot(drug_or, aes(x = factor(Caff), y = AScore)) +
  geom_boxplot() +
  labs(x = "Caffeine", y = "A Score") +
  ggtitle("Box Plot of A Score by Caffeine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$AScore, 0.5), yend = quantile(drug_or$AScore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Caff), y = Cscore)) +
  geom_boxplot() +
  labs(x = "Caffeine", y = "C Score") +
  ggtitle("Box Plot of C Score by Caffeine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Cscore, 0.5), yend = quantile(drug_or$Cscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Caff), y = Escore)) +
  geom_boxplot() +
  labs(x = "Caffeine", y = "E Score") +
  ggtitle("Box Plot of E Score by Caffeine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Escore, 0.5), yend = quantile(drug_or$Escore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Caff), y = Nscore)) +
  geom_boxplot() +
  labs(x = "Caffeine", y = "N Score") +
  ggtitle("Box Plot of N Score by Caffeine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Nscore, 0.5), yend = quantile(drug_or$Nscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Caff), y = Oscore)) +
  geom_boxplot() +
  labs(x = "Caffeine", y = "O Score") +
  ggtitle("Box Plot of O Score by Caffeine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Oscore, 0.5), yend = quantile(drug_or$Oscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Nicotine), y = AScore)) +
  geom_boxplot() +
  labs(x = "Nicotine", y = "A Score") +
  ggtitle("Box Plot of A Score by Nicotine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$AScore, 0.5), yend = quantile(drug_or$AScore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Nicotine), y = Cscore)) +
  geom_boxplot() +
  labs(x = "Nicotine", y = "C Score") +
  ggtitle("Box Plot of C Score by Nicotine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Cscore, 0.5), yend = quantile(drug_or$Cscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Nicotine), y = Escore)) +
  geom_boxplot() +
  labs(x = "Nicotine", y = "E Score") +
  ggtitle("Box Plot of E Score by Nicotine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Escore, 0.5), yend = quantile(drug_or$Escore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Nicotine), y = Nscore)) +
  geom_boxplot() +
  labs(x = "Nicotine", y = "N Score") +
  ggtitle("Box Plot of N Score by Nicotine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Nscore, 0.5), yend = quantile(drug_or$Nscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Nicotine), y = Oscore)) +
  geom_boxplot() +
  labs(x = "Nicotine", y = "O Score") +
  ggtitle("Box Plot of O Score by Nicotine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Oscore, 0.5), yend = quantile(drug_or$Oscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Cannabis), y = AScore)) +
  geom_boxplot() +
  labs(x = "Cannabis", y = "A Score") +
  ggtitle("Box Plot of A Score by Cannabis Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$AScore, 0.5), yend = quantile(drug_or$AScore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Cannabis), y = Cscore)) +
  geom_boxplot() +
  labs(x = "Cannabis", y = "C Score") +
  ggtitle("Box Plot of C Score by Cannabis Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Cscore, 0.5), yend = quantile(drug_or$Cscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Cannabis), y = Escore)) +
  geom_boxplot() +
  labs(x = "Cannabis", y = "E Score") +
  ggtitle("Box Plot of E Score by Cannabis Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Escore, 0.5), yend = quantile(drug_or$Escore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Cannabis), y = Nscore)) +
  geom_boxplot() +
  labs(x = "Cannabis", y = "N Score") +
  ggtitle("Box Plot of N Score by Cannabis Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Nscore, 0.5), yend = quantile(drug_or$Nscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Cannabis), y = Oscore)) +
  geom_boxplot() +
  labs(x = "Cannabis", y = "O Score") +
  ggtitle("Box Plot of O Score by Cannabis Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Oscore, 0.5), yend = quantile(drug_or$Oscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Coke), y = AScore)) +
  geom_boxplot() +
  labs(x = "Cocaine", y = "A Score") +
  ggtitle("Box Plot of A Score by Cocaine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$AScore, 0.5), yend = quantile(drug_or$AScore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Coke), y = Cscore)) +
  geom_boxplot() +
  labs(x = "Cocaine", y = "C Score") +
  ggtitle("Box Plot of C Score by Cocaine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Cscore, 0.5), yend = quantile(drug_or$Cscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Coke), y = Escore)) +
  geom_boxplot() +
  labs(x = "Cocaine", y = "E Score") +
  ggtitle("Box Plot of E Score by Cocaine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Escore, 0.5), yend = quantile(drug_or$Escore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Coke), y = Nscore)) +
  geom_boxplot() +
  labs(x = "Cocaine", y = "N Score") +
  ggtitle("Box Plot of N Score by Cocaine Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Nscore, 0.5), yend = quantile(drug_or$Nscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Heroin), y = AScore)) +
  geom_boxplot() +
  labs(x = "Heroin", y = "A Score") +
  ggtitle("Box Plot of A Score by Heroin Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$AScore, 0.5), yend = quantile(drug_or$AScore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Heroin), y = Cscore)) +
  geom_boxplot() +
  labs(x = "Heroin", y = "C Score") +
  ggtitle("Box Plot of C Score by Heroin Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Cscore, 0.5), yend = quantile(drug_or$Cscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Heroin), y = Escore)) +
  geom_boxplot() +
  labs(x = "Heroin", y = "E Score") +
  ggtitle("Box Plot of E Score by Heroin Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Escore, 0.5), yend = quantile(drug_or$Escore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Heroin), y = Nscore)) +
  geom_boxplot() +
  labs(x = "Heroin", y = "N Score") +
  ggtitle("Box Plot of N Score by Heroin Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Nscore, 0.5), yend = quantile(drug_or$Nscore, 0.5), color = "black", size = 1.2) +
...
ggplot(drug_or, aes(x = factor(Heroin), y = Oscore)) +
  geom_boxplot() +
  labs(x = "Heroin", y = "O Score") +
  ggtitle("Box Plot of O Score by Heroin Consumption Level") +
  theme(panel.border = element_rect(color = "black", fill = NA), 
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) +
  annotate("segment", x = 1:7, xend = 1:7, y = quantile(drug_or$Oscore, 0.5), yend = quantile(drug_or$Oscore, 0.5), color = "black", size = 1.2) +
